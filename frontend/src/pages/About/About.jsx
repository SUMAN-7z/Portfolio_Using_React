      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col left">
            <h2 className="name">Suman Kandi</h2>
            <h3 className="mb-4">
              <TypingEffect
                texts={[
                  "Web Developer",
            ...
            <p className="description">
              Hi, I'm Suman - a Full-Stack Developer specializing in the MERN
              stack. I build modern, user-focused web applications that combine
              clean design with strong backend systems. I'm also pursuing my MCA
              at CUTM to deepen my expertise in computer applications and
              software development. Feel free to explore my work and see how I
              create scalable, intuitive, and impactful solutions.
            </p>

            <div className="gap-3">
              <a href="/resume/Suman_Kandi_Resume.pdf" className="a-1" download>
                <i className="fa-solid fa-download"></i> Resume
              </a>

              <a
                href="https://github.com/SUMAN-7z"
                target="_blank"
                rel="noreferrer"
                className="a-2"
              >
              ...
              <a
                href="https://www.linkedin.com/in/suman-kandi"
                target="_blank"
                rel="noreferrer"
                className="a-2"
              >
              ...
              <a href="mailto:sumankandisuman@gmail.com" className="a-2">
          ...
          <div className="col right">
            <div className="box-main">
              ...
              <div className="icon-wrapper">
                <div className="floating-tag top-left wave-tilt">React</div>
                <div className="box">
                  <img src={ReactLogo} alt="React" className="svg-icon spin" />
                </div>
              </div>

              {/* Node */}
              <div className="icon-wrapper">
                <div className="floating-tag top-right wave-tilt">Node</div>
                <div className="box">
                  <svg
              ...
              {/* MongoDB */}
              <div className="icon-wrapper">
                <div className="floating-tag top-left wave-tilt">MongoDB</div>
